...
<body>
    <div class="container">
        ...
        <section class="promo">
            <h1 class="promo-title">Life insurance application<br>Step 3</h1>
            ...
            <div class="main">
                ...
                <div class="insurance">
                    ...
                    <ul>
                        ...
                        <li>Insurance type: &nbsp; <?php echo $InsuranceType;?></li>
        ...
        <div class="online-payment">
            <div class="online-payment-dialog">
                ...
                if(isset($_POST['last-step'])){
                    ...
                    $sql = "INSERT INTO `life_ins` (`email`, `name`, `surname`, `b-date`, `citizenship`, `passport`, `gender`, `type`, `s-date`, `e-date`) VALUES ('$Email', '$FirstName', '$LastName', '$BirthDate', '$Country', '$Passport', '$Gender', '$InsuranceType', '$StartDate', '$EndDate')";
                    $queryFlag = 0;
                    if($queryFlag == 0){
                        mysqli_query($connection, $sql);
                        // go to final page
                        header('Location:last/success-life/success.php');
                        $queryFlag = 1;
                    }
                }
                ?>
                <div class="payment-form">
                    <form method="POST" action="checkpoint-life.php">
