...
function Header()
{
    ...
    $this->Cell(60);
    // Title
    $this->Cell(77,13,'Travelling insurance',1,0,'C');
    // Line break
    $this->Ln(20);
}
...
$pdf->Cell(0,10,'Location of building: ' . $location,0,1);
$pdf->Cell(0,10,'Age of building: ' . $propertyage,0,1);
$pdf->Cell(0,10,'Type of building: ' . $propertytype,0,1);
$pdf->Cell(0,10,'Area of building: ' . $propertyarea . "m^2",0,1);
