...
$gadgets = $_SESSION['gadgets'];
$gadgetname = $_SESSION['gadgetname'];
$gadgetcondition = $_SESSION['gadgetcondition'];
...
<body>
    <div class="container">
        ...
        <section class="promo">
            <h1 class="promo-title">Gadget insurance application<br>Step 3</h1>
        ...
        <div class="main">
            ...
            <div class="insurance">
                ...
                <ul>
                    ...
                    <li>Gadget type: &nbsp; <?php echo $gadgets;?></li>
					<li>Gadget name: &nbsp; <?php echo $gadgetname;?></li>
					<li>Gadget condition: &nbsp; <?php echo $gadgetcondition;?></li>
        ...
        <div class="online-payment">
            <div class="online-payment-dialog">
                ...
                if(isset($_POST['last-step'])){
                    ...
                    $sql = "INSERT INTO `gadgets_ins` (`email`, `name`, `surname`, `b-date`, `citizenship`, `passport`, `gender`, `gadget`, `gadget-name`, `gadget-condition`, `s-date`, `e-date`) VALUES ('$Email', '$FirstName', '$LastName', '$BirthDate', '$Country', '$Passport', '$Gender', '$gadgets', '$gadgetname', '$gadgetcondition', '$StartDate', '$EndDate')";
                    $queryFlag = 0;
                    if($queryFlag == 0){
                        mysqli_query($connection, $sql);
                        // go to final page
                        header('Location:last/success-gadget/success.php');
                        $queryFlag = 1;
                    }
                }
                ?>
                <div class="payment-form">
                    <form method="POST" action="checkpoint-gadget.php">
