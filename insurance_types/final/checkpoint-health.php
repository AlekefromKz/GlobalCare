...
$sickreason = $_SESSION['sickreason'];
...
<body>
    <div class="container">
        ...
        <section class="promo">
            <h1 class="promo-title">Health insurance application<br>Step 3</h1>
        ...
        <div class="main">
            <div class="person">
                ...
                <ul>
					...
					<li>Last doctor visit: &nbsp; <?php echo $sickreason;?></li>
        ...
        <div class="online-payment">
            <div class="online-payment-dialog">
                ...
                if(isset($_POST['last-step'])){
                    ...
                    $sql = "INSERT INTO `health_ins` (`email`, `name`, `surname`, `b-date`, `citizenship`, `ldvreason`, `passport`, `gender`, `area`, `s-date`, `e-date`) VALUES ('$Email', '$FirstName', '$LastName', '$BirthDate', '$Country', '$sickreason', '$Passport', '$Gender', '$Area', '$StartDate', '$EndDate')";
                    $queryFlag = 0;
                    if($queryFlag == 0){
                        mysqli_query($connection, $sql);
                        // go to final page
                        header('Location:last/success-health/success.php');
                        $queryFlag = 1;
                    }
                }
                ?>
                <div class="payment-form">
                    <form method="POST" action="checkpoint-health.php">
