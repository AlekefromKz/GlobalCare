...
$propertyage = $_SESSION['propertyage'];
$propertyarea = $_SESSION['propertyarea'];
...
<body>
    <div class="container">
        ...
        <section class="promo">
            <h1 class="promo-title">Housing insurance application<br>Step 3</h1>
        ...
        <div class="main">
            ...
            <div class="insurance">
                <h3 class="insurance-info">Property Information</h3>
                <ul>
                    <li>Duration: &nbsp; <?php echo $StartDate . " - " . $EndDate;?></li>
                    <li>Property location: &nbsp; <?php echo $location;?></li>
					<li>Property type: &nbsp; <?php echo $propertytype;?></li>
					<li>Property age: &nbsp; <?php echo $propertyage;?></li>
					<li>Property area (m2): &nbsp; <?php echo $propertyarea;?></li>
        ...
        <div class="online-payment">
            <div class="online-payment-dialog">
                ...
                if(isset($_POST['last-step'])){
                    ...
                    $sql = "INSERT INTO `estate_ins` (`email`, `name`, `surname`, `b-date`, `citizenship`, `passport`, `gender`, `location`, `type`, `age`, `area`, `s-date`, `e-date`) VALUES ('$Email', '$FirstName', '$LastName', '$StartDate', '$Country', '$Passport', '$Gender', '$location', '$propertytype', '$propertyage', '$propertyarea', '$StartDate', '$EndDate')";
                    $queryFlag = 0;
                    if($queryFlag == 0){
                        mysqli_query($connection, $sql);
                        // go to final page
                        header('Location:last/success-estate/success.php');
                        $queryFlag = 1;
                    }
                }
                ?>
                <div class="payment-form">
                    <form method="POST" action="checkpoint-estate.php">
