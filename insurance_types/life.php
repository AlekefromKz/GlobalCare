...
{   
    ...
    $InsuranceType = filter_var(trim($data['InsuranceType']), FILTER_SANITIZE_STRING);
    ...
    if($InsuranceType == '' || $InsuranceType == "Select an insurance type"){ $errors[] = 'Choose your insurance type!';}
    ...
    if(empty($errors))
	{
        ...
        header('Location:final/checkpoint-life.php');
    }
}
?>
...
<head>
    ...
    <title>GlobalCare - Life Insurance</title>
...
<body>
    ...
    <div class="container">
        ...
        <section class="promo">
            <h1 class="promo-title">Life insurance application<br>Step 1</h1>
        ...
        <form action="life.php" method="POST">
            <div class="submit-form">
                ...
                <div class="card insurance">
                    ...
                    <label for="InsuranceType">Insurance type:</label><br><?php require "additional/form-input/insurancetype.php"; ?><br><br>
                    <div class="dates">
